  ...
  <label style="position: absolute; left: 50%; transform: translatex(-50%); " class="">
   ...
   <div class="row container">
    ...
    <div class="container  d">
        ...
        <div class="card bdr mt-3" style="width: 18rem;">
            <img src="pictures/theuser.png" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Manage your profile</h5>
                <p class="card-text"></p>
                <a href="profile-provider.php" class="btn btn-primary">Profile Editor</a>
            </div>
        </div>
        <div class="card bdr mt-3" style="width: 18rem;">
            <img src="pictures/medpostlogo3.jfif" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Donate Medicine</h5>
                <p class="card-text"></p>
                <a href="provider-med-post.php" class="btn btn-primary">Medpost form</a>
            </div>
        </div>
        <div class="card d-flex bdr mt-3" style="width: 18rem;">
            <img src="pictures/lg.jfif" class="card-img-top" alt="..."  >
            <div class="card-body ">
                <h5 class="card-title">Change Password</h5>
         <button class="btn btn-primary mt-2" type="button" data-bs-toggle="modal" data-bs-target="#signupWin">Open Form</button>
            </div>
        </div>
        </div>
    </div>
        <div class="row">
        <div class="container  d">
        <div class="card bdr mt-4 mb-2" style="width: 18rem; ">
            <img src="pictures/medcart1.png" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Manage your Records</h5>
                <p class="card-text"></p>
                <a href="med-manager.php" class="btn btn-primary">Med Manager</a>
            </div>
        </div>
        <div class="card bdr mt-4 mb-2 " style="width: 18rem;">
            <img src="pictures/feedback2.png" class="card-img-top" alt="..." height="270">
            <div class="card-body">
                <h5 class="card-title">Your valuable feedback</h5>
                <p class="card-text"></p>
                <a href="feedback.php" class="btn btn-primary">Feedback form</a>
            </div>
        </div>
        </div>
    </div>
